...
$("#buttonSave").on('click',function(){
  ...
  $.ajax({
            url: "stExport",
            type: 'POST',
            data: {invoiceDate:invoiceDate,country:country,exportType:exportType,shippingDate:shippingDate,portNumber:portNumber,sBillNumber:sBillNumber,notes:notes,dueDate:dueDate,customerId:customerId,billingAddress:billingAddress,
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                window.location="exportInvoice.jsp?sid="+data[0].salesId;
                $("#buttonSave").prop('disabled', false);
            },
          error: function (jqXHR, textStatus, errorThrown) {
                alert("Error");
